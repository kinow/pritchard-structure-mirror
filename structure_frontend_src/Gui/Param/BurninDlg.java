...
public class BurninDlg extends JDialog {
	...
	public BurninDlg(Component owner, NSimObj sim, boolean def) {

		this.sim = sim;

		JLabel l1 = new JLabel("ADMBURNIN: ");

		burninField = new JTextField(10);
		...
		if (!sim.isNew() && !def) {
			burnin = sim.ADMBURNIN;
			burninField.setText("" + burnin);
		}
	}
