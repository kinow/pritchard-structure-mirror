...
public class PAParserTokenManager implements PAParserConstants {
				...
				MatchLoop: do {
					...
					case 54:
						if ((0x3ff000000000000L & l) != 0L) {
							...
							jjCheckNAddTwoStates(56, 13);
						}
						break;
					case 17:
						if ((0xff000000000000L & l) != 0L) {
							jjCheckNAddTwoStates(15, 20);
						} else if ((0x28000000400L & l) != 0L) {
	...
	static final int[] jjnextStates = { 15, 16, 18, 33, 7, 54, 60, 64, 13, 40,
			4, 34, 45, 49, };
	...
	public PAParserTokenManager(ASCII_UCodeESC_CharStream stream) {
	...
	public PAParserTokenManager(ASCII_UCodeESC_CharStream stream, int lexState) {
		this(stream);
		SwitchTo(lexState);
	}
