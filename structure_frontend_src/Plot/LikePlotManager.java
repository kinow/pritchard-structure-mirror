...
public class LikePlotManager {
	...
	public LikePlotManager() {
	}

	public void plot(double[][] plotdata, String title) {

		stg = new Plot(plotdata[0], "Like", "Ln Likelihood Vs. Iterations");
		JPanel p = new JPanel();
		...
		target = new JFrame("Structure Plotting: Ln Likelihood - " + title);
	...
	public void plot(AppProc proc) {
		...
		final Plot g = new Plot(proc, "Like", 1, "Ln Likelihood Vs. Iterations");
		g.start();
		...
		target = new JFrame("Structure Plotting: Ln Likelihood");
		target.addWindowListener(new WindowAdapter() {
			public void windowClosing(WindowEvent e) {
				g.stop();
				target.setVisible(false);
	...
	public void plotHist(double[][] data, String title) {
		...
		HistPlot hist = new HistPlot(data[0], "Log likihood", "Histogram");
		...
		target = new JFrame("Histogram of distribution of log likihood - "
				+ title);
		target.addWindowListener(new WindowAdapter() {
			public void windowClosing(WindowEvent e) {
				target.setVisible(false);
